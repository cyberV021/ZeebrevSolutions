...
<html lang="en">
    ...
    <body>
        ...
        <!-- End Navbar Area --> <!--Start Page Header Area-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-contact-card">
                            <div class="icon">
                            <a href="mailto:infozeebrev@gmail.com"><i class="flaticon-mail"></i></a>
                            </div>
                            <h3>Email Address:</h3>
                            <a href="mailto:infozeebrev@gmail.com">infozeebrev@gmail.com</a>
                     ...
                     <div class="col-lg-4 col-sm-6">
                        <div class="single-contact-card">
                            <div class="icon">
                            <a href="https://goo.gl/maps/k1i3c6Bs3P5xWRjf8"><i class="flaticon-placeholder"></i></a>
                            </div>
                            <h3>Address:</h3>
                            <span><a href="https://goo.gl/maps/k1i3c6Bs3P5xWRjf8">Office No.806-809-810 Harikrupa Tower, Above Khadi Mandir, Nr Sophos Nr. Kalagi Cross Road, Ellisbridge, Ahmedabad, Gujarat Gujarat Collage, To, Parimal Garden Road, Ahmedabad, Gujarat 380006,India.</a>
</span>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-contact-card">
                            <div class="icon">
                            <a href="tel:+918469555787"><i class="flaticon-phone-call-1"></i></a>
                            </div>
                            <h3>Phone Number:</h3>
                            <a href="tel:+918469555787">+91 84695 55787</a>
